        ...
        formGrid: {
          ...
          form: {
            ...
            columns: [
              ...
              {label: "开始时间", type: "datetime", name: "startTime", fieldFormat:(value)=>{
                //编辑时必须格式化成date对象，避免无法编辑,属于iview的一个bug
               // return new moment(value,"YYYY-MM-DD hh:mm:ss");
                return value;
              }},
              {label: "结束时间", type: "datetime", name: "endTime",fieldFormat:(value)=>{
                //编辑时必须格式化成date对象，避免无法编辑,属于iview的一个bug
                //return new moment(value,"YYYY-MM-DD hh:mm:ss");
                return value;
              }},
              {
                label: "秒杀商品", type: "text", name: "goodsInfo", placeholder: "点击选择要参加活动的商品",readonly:true,
                required: true, focus: () => {
                console.log("click");
                //弹出商品选择界面
                this.showSelectGoodsInfo = true;
              }, view:{show:false},edit:{show:false},
              },
              {
                label: "秒杀商品", type: "text", name: "goodsInfoName",
                add:{show:false},
                view:{show:true},
                edit: {
                  show: true, disabled: true
